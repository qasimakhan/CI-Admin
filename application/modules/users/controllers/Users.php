...
class Users extends MY_Controller {
    ...
    function checkEmailExists()
    {
        ...
        if(empty($userId)){
            ...
            $result = $this->users_model->checkEmailExists($email, $userId);
        }
    ...
    function addNewUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $this->load->model('users_model');
                $result = $this->users_model->addNewUser($userInfo);
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $data["userInfo"] = $this->users_model->getUserInfoById($userId);
            ...
            $count = $this->users_model->loginHistoryCount($userId, $searchText, $fromDate, $toDate);
    ...
    function profileUpdate($active = "details")
    {
        ...
        else
        {
            ...
            $result = $this->users_model->editUser($userInfo, $this->vendorId);
    ...
    function changePassword($active = "changepass")
    {
        ...
        else
        {
            ...
            $resultPas = $this->users_model->matchOldPassword($this->vendorId, $oldPassword);
            ...
            else
            {
                ...
                $result = $this->users_model->changePassword($this->vendorId, $usersData);
